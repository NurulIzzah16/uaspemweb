...
<body>
	...
	<table id="example" class="display" cellspacing="0" width="100%" border="0" >
        ...
        <tbody>
        <?php
            $query = mysqli_query($conn, "SELECT * FROM setor ORDER BY id ASC");
        ...
        <tr align="center">
            ...
            <td>
                ...
                <a href="admin.php?page=edit-setor&id=<?php echo $row['id']; ?>">
                <button><i class="fa fa-pencil"></i>edit</button> 
                </a>

                <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="../system/function/delete-setor.php?id=<?php echo $row['id']; ?>">
