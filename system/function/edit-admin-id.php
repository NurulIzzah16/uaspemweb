<?php
 ...
 if (isset($_POST['simpan'])) {
  ...
  $query = "UPDATE admin SET nama = '$nama', no_telepon = '$no_telepon', email = '$username', password = '$password' WHERE id='".$id."' ";
...
<body>
     ...
     <?php 
        $cek = mysqli_query($conn, "SELECT * FROM admin WHERE id='".$_GET['id']."'");
        $row = mysqli_fetch_array($cek);
      ?>
  
          <form action="" method="post">
          <label class="text-left">Nomor ID Admin</label>
          <input type="text" style="cursor: not-allowed;" name="id" disabled="disabled" value="<?php echo $_GET['id']; ?>" />
