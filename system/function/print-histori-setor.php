...
$query = "SELECT * FROM setor WHERE id_nasabah='".@$_SESSION['id']."' ORDER BY id DESC"; 
...
$pdf->SetTitle('Data Penyetoran Sampah');
$pdf->SetSubject('Laporan');
$pdf->SetKeywords('Data, Sampah, PDF, Laporan');
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'Data Penyetoran Sampah', 'Bank Sampah Kosmetik Lowayu');
...
$filename = "Data-Penyetoran-Sampah-(".date('d-m-Y').").pdf";
