...
if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO sampah (id, jenis_sampah, satuan, harga, gambar, deskripsi) VALUES ('$id','$jenis_sampah','$satuan','$harga','$gambar','$deskripsi')");
    ...
    if ($query) {
        ...
        echo "<meta http-equiv='refresh'
              content='0; url=http://localhost/pilah_cantik/page/admin.php?page=data-sampah'>";
    } else {
        echo "
        <script>
        ...
        echo "<meta http-equiv='refresh'
              content='0; url=http://localhost/pilah_cantik/page/admin.php?page=data-sampah'>";
        echo mysqli_error($conn); // Menampilkan pesan error dari MySQL
    }
}
?>
