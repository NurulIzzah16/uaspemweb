...
<html>
	...
	<body>
		...
		<div class="sidebar">
			<ul>
				<li>
					<a href="admin.php?page=data-admin" style="text-align: center; padding: 30px 0 30px 0; font-size: 20px;"><?php echo $row['nama'] ?></a>
				</li>
				...
				<?php 
					...
					switch ($page) {
						...
						case 'tambah-data-sampah':
							...
							break;
						case 'tambah-tarik':
							include "../system/function/tambah-data-tarik.php";
							break;	
						case 'edit-tarik':
							include "../system/function/edit-tarik.php";
							break;		
						default:
